...
def create_parser():
	...
	parser.add_argument( "--invasion_rate",
		type=float,
		metavar="float",
		help="invasion rate")
	parser.add_argument( "--pi1",
		type=float,
		metavar="float",
		help="resident hypermutaion threshold in fitness")
	parser.add_argument( "--tau1",
		type=float,
		metavar="float",
		help="resident hypermutaion rate fold increase")
	parser.add_argument( "--pi2",
		type=float,
		metavar="float",
		help="invader hypermutaion threshold in fitness")
	parser.add_argument( "--tau2",
		type=float,
		metavar="float",
		help="invader hypermutaion rate fold increase")
